...
export default function C() {
  ...
  return (
    <div style={family} className="homeb">
      <div className="go-down-c">
        <div className="shrink-c">
          <div className="c">
            <div className="box-shadow-c-title">
              <div className="display-flex-svg-and-p">
                <div className="svg">
                  <svg
                    ...
                    xmlSpace="preserve"
                  >
                    <path d="M230 222.087V7.913H0v179h174.813L230 222.087zM15 22.913h200v171.826l-35.814-22.826H15v-149zm47.75 89.167h104.5v15H62.75v-15zm0-44.333h104.5v15H62.75v-15z"></path>
                  </svg>
                </div>
              ...
              <div className="display-flex-svg-and-p">
                ...
                <p>Publicité par Appel</p>
              </div>
            </div>
            <div className="box-shadow-c">
              <p>
                Lorsque vous passer votre Publicité chez Omisify Business, elle
                est présenté aux partenaires Omisify en fonction du pays que
                vous avez choisi
              </p>
              <p>
              ...
              <div className="align-button">
                <NavLink to="/signup">
                  <button>Essayer la Publicité</button>
                </NavLink>
              </div>
            </div>
            ...
            <div className="go-down-this">
              ...
              <p>
                ...
                Partenaires Omisify Influenceurs Vidéos enregistrent de
                nouvelles vidéos dans lequel ils parlent de votre produit ou de
                votre entreprise. Ainsi leur millions d'abonnés qui leur font
                confiance tomberont sur la nouvelle vidéo qui parle de votre
                produit et courriront pour en savoir plus ou pour effectuer
                l'achat de votre produit. Car tout les jours leurs abonnés
                effectuent des achats, ils dépensent de l'argent tout les jours,
                et nombreux seront intéréssés par l'offre que vous proposez
              </p>
            ...
            <div className="go-down-this">
              ...
              <p>
                ...
                vous nous avez fourni et les publies sur leur différents réseaux
      ...
      <div className="display-flex-partner-c">
        <div className="partner-c">
          <button>Publicité par les Partenaires Omisify Influents</button>
        </div>

        <div className="partner-c">
          <button>Publicité par les Partenaires Omisify</button>
        </div>

        <div className="partner-c">
          <button>Publicité par les Partenaires Omisify Vidéastes</button>
        </div>
      </div>
      ...
      <p>Publicité par Message</p>
      <p>Publicité par Appel</p>
      <p>Publicité en commentaire</p>
      <p>Publicité par e-mail</p>
      <p>Publicité par partage</p>
      <p>Publicité E10k</p>
      <p>Publicité MWI</p>
      <p>Publicité M10k</p>
      <p>Publicité par publication</p>
      <p>Publicité PWI</p>
      <p>Publicité PWP</p>
      <p>Publicité par vidéo</p>
