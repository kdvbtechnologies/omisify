            ...
            <div className="border">
              {pointtpublicationlife ? (
                <>
                  ...
                  <p>Publication(s) : {pointtpublicationlife} point(s)</p>
              ...
              <div className="go-down-i">
                <div className="b">
                  <i>
                    ...
                    votre travail affichés sur cette page sont conformes à ce
                    que vous avez calculés
                  </i>
                </div>
