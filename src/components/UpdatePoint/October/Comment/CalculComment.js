        ...
        <div className="a">
          ...
          <div className="display-calcul-comment-title">
            <div className="calcul-comment-title">
              ...
              <div className="b">
                <p onClick={InfosComment}>Commentaire</p>
              </div>
          ...
          <div onClick={InfosComment} className="popup-infos-comment-opacity">
            <div className="align">
              <div className="card">
                <div className="display">
                  <p>L'option</p>
                  <p style={{ color: "red" }}>Commentaire</p>
                  <p>s'agit</p>
                  <p>d'un</p>
                  <p>commentaire publicitaire</p>
                  <p>concernant un produit</p>
                  <p>
                    ou une entreprise publié par le Partenaire Omisify sur sa
                    propre publication ou sur la publication d'une autre
                    personne
                  </p>
                </div>
