...
export default function NavbarBottomCategorieVI() {
  return (
    <>
      <div className="navbar-bottom-vi">
        <NavLink style={{ textDecoration: "none" }} to="/home-user-vi">
          <div className="a">
            ...
            <li style={{ color: "#fed5b3" }}>Recommandé</li>
          </div>
        </NavLink>

        <NavLink style={{ textDecoration: "none" }} to="/before-categorie-app">
          <div className="a">
            <svg className="active-class-vi" viewBox="0 0 20 20" width="28px">
            ...
            <li style={{ color: "white" }}>Catégories</li>
          </div>
        </NavLink>

        <NavLink style={{ textDecoration: "none" }} to="/profil-user-vi">
          <div className="a">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0"
            ...
            <li style={{ color: "#fed5b3" }}>Profil</li>
          </div>
        </NavLink>
      </div>
    </>
