...
export default function ForgotPasswordVI() {
    ...
    <>
      ...
      <div className="signup-vi">
        <div className="signup-vi-border">
          ...
          <p>
            Réinitialiser le mot de passe de votre compte Vixinol Store en
            entrant votre adresse e-mail ou votre id
          </p>
