...
export default function NewPasswordPartnerVI() {
    ...
    <>
      ...
      <div className="signup-vi">
        <div className="signup-vi-border">
          ...
          <p>
            Entrer un nouveau mot de passe pour votre compte Vixinol Store for
            Developers
          </p>
          ...
          <NavLink to="/new-password-success-partner-vi">
            <button>Créer</button>
          </NavLink>
        </div>
      </div>
