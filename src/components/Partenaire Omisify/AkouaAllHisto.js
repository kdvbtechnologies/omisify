    ...
    <div style={family}>
      ...
      <div className="all-historical">
        ...
        <NavLink
          ...
          to="/akoua-histo-twenty"
        >
          <div className="one-historical">
            <p>
              [Nouveau] 12/10/2022 - 10 M10k, 2 MWI, 3 publications, 1 E-mail et
              31 commen..
            </p>
          </div>
        </NavLink>
        ...
        >
          <div className="one-historical">
            <p>11/10/2022 - 8 MWI, 11 commentaires et 7 me..</p>
          </div>
        </NavLink>
        <div className="hr">
          <hr />
        ...
        <NavLink
          className="one-historical-text-decoration"
          to="/akoua-histo-sixteen"
        >
          <div className="one-historical">
            <p>08/10/2022 - Samedi 08 Octobre • 244 messages et 5 co..</p>
          </div>
        </NavLink>
        <div className="hr">
          <hr />
        ...
        >
          <div className="one-historical">
            <p>
              07/10/2022 - 234 messages, 28 commentaires et 2 publications du
              Progra..
            </p>
          </div>
        </NavLink>
